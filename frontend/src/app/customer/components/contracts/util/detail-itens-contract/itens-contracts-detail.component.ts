...
@Component({
  ...
  templateUrl: './itens-contracts-detail.component.html',
  styleUrls: ['./itens-contracts-detail.component.css']
})
export class ItensContractsDetailComponent implements OnInit, OnChanges, AfterViewInit, OnDestroy {
